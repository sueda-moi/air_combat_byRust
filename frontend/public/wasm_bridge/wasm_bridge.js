...
/**
 * @param {Uint8Array} _serialized_tx
 * @returns {Promise<any>}
 */
export function sign_and_send_transaction(_serialized_tx) {
    const ptr0 = passArray8ToWasm0(_serialized_tx, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.sign_and_send_transaction(ptr0, len0);
    return ret;
}
